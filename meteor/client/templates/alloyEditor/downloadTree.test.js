...
describe("downloadTree", function() {
    it("flat descendants converted to tree with no descendants", function() {
    ...
    it("flat descendants converted to tree with multilevel descendants", function() {
        chai.assert.equal(JSON.stringify(descendantsToTree({
            descendants: [{
                _id: 2,
                derivationOf: 1
